...
public class Polygon {
     ...
     * 2 < ∣S∣ < ∞
     */
    public ArrayList<davidmarino.model.Point> vertices;
    /**
     ...
     */
    public davidmarino.model.Point site;
     ...
     */
    public Polygon(ArrayList<davidmarino.model.Point> vertices, davidmarino.model.Point site) {
     ...
     * @param vertices are the points of the polygon
     */
    public Polygon(ArrayList<davidmarino.model.Point> vertices) {
        this.vertices = vertices;
        this.neighbors = new HashSet<>();
        this.site = null;
    }
     ...
     * @param site is the point this polygon is orientated
     */
    public Polygon(ArrayList<davidmarino.model.Point> vertices, HashSet<Polygon> neighbors, davidmarino.model.Point site) {
        this.vertices = vertices;
