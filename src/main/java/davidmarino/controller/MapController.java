...
public class MapController {
    ...
    @PostMapping("/map")
    public ResponseEntity handleLocalMapPost(@RequestBody Parameters parameters) {
        return ControllerUtil.getStringResponse(DungeonQuest.getMap(parameters).getJson(), 200);
    }
}
