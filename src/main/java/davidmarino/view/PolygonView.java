...
public class PolygonView {
     ...
     */
    public static void drawPolygonBorder(Graphics2D g2, davidmarino.model.Polygon polygon, Color color) {
        int n = polygon.vertices.size();
        int[] xPoints = new int[n];
        int[] yPoints = new int[n];
        for (int i = 0; i < n; i++) {
     ...
     */
    public static void drawFilledPolygons(Graphics2D g2, ArrayList<davidmarino.model.Polygon> polygons) {
     ...
     */
    public static void drawPolygonBorders(Graphics2D g2, ArrayList<davidmarino.model.Polygon> polygons, Color color) {
