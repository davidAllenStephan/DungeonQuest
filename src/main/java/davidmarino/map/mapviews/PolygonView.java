package davidmarino.map.mapviews;
...
public class PolygonView {
     ...
     */
    public static void drawFilledPolygons(Graphics2D g2, ArrayList<Polygon> polygons, double waterLevel, double coastLevel, double whiteCapLevel) {
     ...
     */
    public static void drawPolygonBorders(Graphics2D g2, ArrayList<Polygon> polygons, int edgeWeight, Color color) {
        for (Polygon polygon : polygons) {
